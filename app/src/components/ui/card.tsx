...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Edge is a 1px `border` token, matching DESIGN.md §Cards and `Panel`.
        // Upstream shadcn ships `ring-1 ring-foreground/10`, which is a
        // different mechanism at a different opacity — keep this themed.
